...
class Game_Ui_Class(QMainWindow):
...
"}")
        ...
        self.game_time_txt = QtWidgets.QLabel(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.game_time_txt.sizePolicy().hasHeightForWidth())
        self.game_time_txt.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("OCR A Extended")
        font.setPointSize(50)
        font.setBold(False)
        font.setWeight(50)
        self.game_time_txt.setFont(font)
        self.game_time_txt.setStyleSheet("color: rgb(0, 0, 255);")
        self.game_time_txt.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.game_time_txt.setAlignment(QtCore.Qt.AlignCenter)
        self.game_time_txt.setObjectName("game_time_txt")
        self.horizontalLayout.addWidget(self.game_time_txt)
...
"}")
        ...
        self.game_progres_bar.setProperty("value", 0)
